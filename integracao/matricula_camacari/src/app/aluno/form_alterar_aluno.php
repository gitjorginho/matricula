                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input class="form-control" type="text" name="vch_nome" id="vch_nome" value="<?php echo @$aluno['ed47_v_nome'] ?>" onkeyup="this.value = this.value.toUpperCase();" onKeyPress="mudarCorCampo('labelNome', 'vch_nome')" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input class="form-control" type="text" name="vch_mae" id="vch_mae" value="<?php echo trim(@strtoupper($aluno['ed47_v_mae'])) ?>" onkeyup="this.value = this.value.toUpperCase();" onKeyPress="mudarCorCampo('labelNomeMae', 'vch_mae')">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-9">
                                        ...
                                        <input class="form-control" type="text" name="vch_responsavel" id="vch_responsavel" value="<?php echo trim(@strtoupper($aluno['ed47_c_nomeresp'])) ?>" onkeyup="this.value = this.value.toUpperCase();" onKeyPress="mudarCorCampo('labelNomeResponsavel', 'vch_responsavel')">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <select class="custom-select" onclick="pegarValores(this)" id="resposta" style=" margin-left: 0px;display: none" name="vch_endereco" multiple="multiple" onchange="mudarCorCampo('labelEndereco', 'cp_texto')"></select>
                                    </div>
                                </div>
                            </div>
                            <br>
