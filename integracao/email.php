...
function envialEmail($mensagem,$mailDestino,$anexoCaminho, $mailDestinoSecundario)
{
    ...
    */
    ...
    $nome = 'SEDUC';
    $assunto = 'Portal Lista de Espera';
    ...
    $mail->FromName = "Portal Lista Reserva"; // Nome de quem envia o email
    $mail->AddAddress($mailDestino, $nome); // Email e nome de quem receberÃ¡ //Responder
    if ($mailDestinoSecundario != ''){
        $mail->AddAddress($mailDestinoSecundario, $nome); // Email e nome de quem receberÃ¡ //Responder    
    }
