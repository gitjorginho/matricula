            ...
            <div class="row">
                <div class="col"style="text-align: center">
                    <div class="card-body">
                        ...
                        <input autocomplete="off" class="form-control col-md-12" type="text" id="cp_texto">
...
?>
                ...
                <div class="col-md-6"> 
                    <label for="vch_cidade">Cidade</label><span>*</span>
