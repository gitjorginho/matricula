...
require_once("classes/db_turmaturnoadicional_classe.php");
...
for ($z = 0; $z < $clperiodoescola->numrows; $z++) {
    ...
    $result = $cldiasemana->sql_record(die($cldiasemana->sql_query_rh("", "*", "ed32_i_codigo", " ed04_c_letivo = 'S' AND ed04_i_escola = $escola")));
    ...
    if ($turno != $ed15_c_nome) {
        ...
        if ($ed15_c_nome === "MANHÃ 2" or $ed15_c_nome === "MANHÃ 1") {
            $Led15_c_nome = "MATUTINO";
        } elseif ($ed15_c_nome === "TARDE 2" or $ed15_c_nome === "TARDE 1") {
            $Led15_c_nome = "VESPERTINO";
        } elseif ($ed15_c_nome === "NOITE 2" or $ed15_c_nome === "NOITE 1") {
            $Led15_c_nome = "NOTURNO";
        }
        $pdf->cell(35, 5, trim($Led15_c_nome), 1, 0, "C", 1);
