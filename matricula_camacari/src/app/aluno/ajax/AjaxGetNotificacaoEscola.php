...
$sql_consula = "
    select 
        ...
        rtrim(ed18_c_homepage) as ed18_c_homepage 
...
$resultconsulta = $stmt->fetch(PDO::FETCH_ASSOC);
    ...
    if ($_SESSION['statusAluno'] == 7){
        ...
        if (trim($resultconsulta['email'])!='' or trim($resultconsulta['ed18_c_homepage'])!=''){
            echo              "<div class='form-group'>";
            echo                  "<div class='row'>";
            echo                       "<div class='col' style='text-align: center'>"; 
            echo                            "<input type='checkbox' class='checkbox' checked id='NotificarEscola' name='NotificarEscola' value='1'>"; 
