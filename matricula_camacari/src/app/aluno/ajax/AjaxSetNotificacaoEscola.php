...
//die($sql_consula);
    ...
    *******************************************************************************/
    ...
    $oPdf->Output('F',"/tmp/AutorizacaoMatricula.pdf");
   ...
   /* Verifica se o orgão público foi inserido, caso positivo infomar como responsável. no e-mail */
    ...
    <html lang='en'>
        ...
        <table style='width: 100%;'>
            <tr> 
                <td>
                    ...
                    <br>
                        <p>Para realizar o processo de matrícula são necessárias as seguintes documentações:</p>
                        <br> 
                        <p>1. Histórico escolar (origina) ou atestado escolar com validade de 60 dias;</p>
                        <p>2. Certidão de Registro Civil ou RG;</p>
                        <p>3. Comprovante de residência;</p>
                        <p>4. Duas fotos 3x4 recentes;</p>
                        <p>5. Cartão de vacina (para educação infantil e anos iniciais);</p>
                        <p>6. Cartão do Sistema Único de Saúde (SUS).</p>
                    <br>
     ...
     $mailDestinoCoordMatricula = ['seduccmie@educa.camacari.ba.gov.br','milena.gomes@educa.camacari.ba.gov.br'];
    

    if (trim($resultconsulta['ed18_c_homepage'])!=''){
        array_push($mailDestinoCoordMatricula,trim($resultconsulta['ed18_c_homepage']));
    }
    
    if(trim($resultconsulta['ed18_c_email']) != ''){
        array_push($mailDestinoCoordMatricula,trim($resultconsulta['ed18_c_email']));
    }
    ...
    if ($_GET['notificarEscola'] == 'true')
        ...
        envialEmail($mensagem,$mailDestinoEscola,'/tmp/AutorizacaoMatricula.pdf',$mailDestinoCoordMatricula);
        ...
        *******************************************************************************/
        ...
        envialEmail($mensagem,$mailDestinoCoordMatricula,'/tmp/AutorizacaoMatricula.pdf','');
    }
?>