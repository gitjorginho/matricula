...
switch ($_GET['funcao']) {
    case'localizar_endereco':
        ...
        $enderecos = $localidade->findEndereco($_GET['endereco'],$_GET['localidade']);

        foreach ($enderecos as $endereco) {
            echo "<option data-endereco='{$endereco['j13_codi']}' value='{$endereco['j14_codigo']}'>" . $endereco['j14_nome'] . " - " . $endereco['j13_descr'] .' - '.$endereco['loc_v_nome']."</option>";
        }
        break;
